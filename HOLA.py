...
st.markdown(
    ...
    .stChatInput textarea::before {{
        ...
        left: 30% !important;
        animation: particula3 2.5s ease-in-out infinite 1s !important;
    }}

    .stChatInput textarea::after {{
        bottom: 10px !important;
        right: 25% !important;
        animation: particula4 2.8s ease-in-out infinite 1.5s !important;
    }}

    /* Más partículas usando box-shadow */
    .stChatInput {{
        animation: particulas-multiples 3s ease-in-out infinite !important;
    }}

    @keyframes particulas-multiples {{
        0%, 100% {{
            box-shadow: 
                -20px 15px 0 -3px rgba(34, 197, 94, 0),
                20px 18px 0 -3px rgba(34, 197, 94, 0),
                0px 12px 0 -3px rgba(34, 197, 94, 0),
                -35px 20px 0 -3px rgba(34, 197, 94, 0),
                35px 15px 0 -3px rgba(34, 197, 94, 0);
        }}
        25% {{
            box-shadow: 
                -25px -5px 0 -2px rgba(34, 197, 94, 0.4),
                25px -3px 0 -2px rgba(34, 197, 94, 0.4),
                0px -8px 0 -2px rgba(34, 197, 94, 0.4),
                -40px 0px 0 -2px rgba(34, 197, 94, 0.4),
                40px -2px 0 -2px rgba(34, 197, 94, 0.4);
        }}
        50% {{
            box-shadow: 
                -30px -25px 0 -1px rgba(34, 197, 94, 0.6),
                30px -23px 0 -1px rgba(34, 197, 94, 0.6),
                0px -28px 0 -1px rgba(34, 197, 94, 0.6),
                -45px -20px 0 -1px rgba(34, 197, 94, 0.6),
                45px -22px 0 -1px rgba(34, 197, 94, 0.6);
        }}
        75% {{
            box-shadow: 
                -35px -45px 0 0px rgba(34, 197, 94, 0.3),
                35px -43px 0 0px rgba(34, 197, 94, 0.3),
                0px -48px 0 0px rgba(34, 197, 94, 0.3),
                -50px -40px 0 0px rgba(34, 197, 94, 0.3),
                50px -42px 0 0px rgba(34, 197, 94, 0.3);
        }}
    }}
